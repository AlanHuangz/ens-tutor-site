const sceneConfig = [
  ...
  { url: 'scenes/scene3.html', name: '第 3 幕：最正確的開啟方式', duration: 9200 },
  { url: 'scenes/scene4.html', name: '第 4 幕：教育樣貌的來源', duration: 7400 },
  { url: 'scenes/scene5.html', name: '第 5 幕：標準與效率', duration: 7400 },
  { url: 'scenes/scene6.html', name: '第 6 幕：工業時期已經很遠', duration: 5200 },
  { url: 'scenes/scene7.html', name: '第 7 幕：科技快速前進', duration: 7400 },
  { url: 'scenes/scene8.html', name: '第 8 幕：不是每個人都一樣', duration: 7400 },
  { url: 'scenes/scene9.html', name: '第 9 幕：神經多樣性', duration: 7400 },
  { url: 'scenes/scene10.html', name: '第 10 幕：學習方式不同', duration: 7400 },
  { url: 'scenes/scene11.html', name: '第 11 幕：體制裡的困難', duration: 7400 },
  { url: 'scenes/scene12.html', name: '第 12 幕：老師們已經很努力', duration: 7400 },
  { url: 'scenes/scene13.html', name: '第 13 幕：同時顧及每個孩子', duration: 5200 },
  { url: 'scenes/scene14.html', name: '第 14 幕：量身設計', duration: 7400 },
  { url: 'scenes/scene15.html', name: '第 15 幕：自我決定論', duration: 7400 },
  { url: 'scenes/scene16.html', name: '第 16 幕：自主感', duration: 7400 },
  { url: 'scenes/scene17.html', name: '第 17 幕：勝任感', duration: 7400 },
  { url: 'scenes/scene18.html', name: '第 18 幕：歸屬感', duration: 9200 },
  { url: 'scenes/scene19.html', name: '第 19 幕：AI 配合節奏', duration: 5200 },
  { url: 'scenes/scene20.html', name: '第 20 幕：學習有更多選擇', duration: 7400 },
  { url: 'scenes/scene21.html', name: '第 21 幕：選擇權與自主感', duration: 7400 },
  { url: 'scenes/scene22.html', name: '第 22 幕：AI 耐心拆解', duration: 8200 },
  { url: 'scenes/scene23.html', name: '第 23 幕：不用擔心不耐煩', duration: 7400 },
  { url: 'scenes/scene24.html', name: '第 24 幕：隨時想問就問', duration: 5200 },
  { url: 'scenes/scene25.html', name: '第 25 幕：給予足夠時間', duration: 7400 },
  { url: 'scenes/scene26.html', name: '第 26 幕：勝任感被滿足', duration: 5200 },
  { url: 'scenes/scene27.html', name: '第 27 幕：老師家長有餘裕', duration: 7400 },
  { url: 'scenes/scene28.html', name: '第 28 幕：照顧與接住孩子', duration: 7400 },
  { url: 'scenes/scene29.html', name: '第 29 幕：歸屬感建立', duration: 7400 },
  { url: 'scenes/scene30.html', name: '第 30 幕：不是學不會', duration: 7400 },
  { url: 'scenes/scene31.html', name: '第 31 幕：重新願意學', duration: 9200 }
];
